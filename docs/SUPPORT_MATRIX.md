...
| ------------------------------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| TypeScript `.ts`, `.tsx`, `.mts`, and `.cts` files                                                            | Supported | TypeScript compiler program and normalized source spans              | JavaScript files and declaration files are excluded; bounded build/dependency directories are excluded and generated provenance is reported                   |
...
| Generated directories, filename/inline markers, configured generated exclusions, and `generated-from` markers | Supported | Generated-file source span, SHA-256 hash, and marker path            | Excluded generated files emit `EXCLUDED_GENERATED_FILE`; unresolved explicit source markers emit `GENERATED_SOURCE_UNRESOLVED`; generators are never executed |
