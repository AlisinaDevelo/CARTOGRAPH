...
| Dynamic routes, imports, HTTP destinations, event/queue names, reflective handlers, or unresolved calls | Stable diagnostics with source evidence and remediation; no guessed edge      |
